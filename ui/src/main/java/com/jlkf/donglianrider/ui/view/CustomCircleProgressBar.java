...
public class CustomCircleProgressBar extends View {
    ...
    public CustomCircleProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        outsideRadius = a.getDimension(R.styleable.CustomCircleProgressBar_outside_radius, MeasureUtil.dip2px(getContext(), 60.0f));
        ...
        progressTextSize = a.getDimension(R.styleable.CustomCircleProgressBar_progress_text_size, MeasureUtil.dip2px(getContext(),  14.0f));
        progressWidth = a.getDimension(R.styleable.CustomCircleProgressBar_progress_width, MeasureUtil.dip2px( getContext(), 10.0f));
...
//        canvas.drawText(progressText, getMeasuredWidth() / 2 - rect.width() / 2, baseline, paint);
    ...
    public IProgressListener setIProgressListener(IProgressListener iProgressListener) {
     return    this.mIProgressListener = iProgressListener;
    }
...
//        animator.setStartDelay(500);
        animator.setDuration(mProgress_time);
...
//                Toast.makeText(getContext(),"z动画执行完成",Toast.LENGTH_SHORT).show();
                if (mIProgressListener != null) {
                    mIProgressListener.finsh();
                }
            }
        });
