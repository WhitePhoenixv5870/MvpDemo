...
public class DividerGridItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public int getMargin_line() {
        return margin_line;
    }

    public void setMargin_line(int margin_line) {
        this.margin_line = margin_line;
        this.marginRight = margin_line;
        this.marginLeft = margin_line;
    }
...
//                Log.d("线的数据left", "##" + left);
//                Log.d("线的数据top", "##" + top);
//                Log.d("线的数据right", "##" + right);
//                Log.d("线的数据bottom", "##" + bottom);
