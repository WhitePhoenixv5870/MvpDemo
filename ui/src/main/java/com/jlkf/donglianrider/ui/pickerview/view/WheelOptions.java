package com.jlkf.donglianrider.ui.pickerview.view;
...
import com.jlkf.donglianrider.ui.pickerview.adapter.ArrayWheelAdapter;
import com.jlkf.donglianrider.ui.pickerview.listener.OnOptionsSelectChangeListener;
import com.jlkf.donglianrider.ui.pickerview.wheelview.listener.OnItemSelectedListener;
import com.jlkf.donglianrider.ui.pickerview.wheelview.view.WheelView;
...
public class WheelOptions<T> {
    ...
    public void setCustomVisibility(boolean visibility) {
    ...
    //不联动情况下
    public void setNPicker(final List<T> options1Items, List<T> options2Items, List<T> options3Items) {
        ...
        wv_option1.setOnItemSelectedListener(new OnItemSelectedListener() {
            ...
            public void onItemSelected(int index) {
                if (isVisibility) {
                    //心率大于149显示label
                    Object o = options1Items.get(index);
                    if (o instanceof Number) {
                        int v = (int) o;
                        if (v > 149)
                            wv_option1.setMaxTextShow(true);
                        else
                            wv_option1.setMaxTextShow(false);
                    }
                }
                if (optionsSelectChangeListener != null)
